...
public class DataBase_RMS {
   ...
   public void setEditAbsentName_3(String s) {
    ...
    public void setGSMNumber(String s) {

        openRecStore();
        this.gsm_number = s;

        try {
            recStore.setRecord(101, gsm_number.getBytes(),
                               0,
                               gsm_number.length());
        } catch (Exception e) {
    ...
    public void setAbsentVoiceOnOff(String s) {

        openRecStore();
        this.absentVoiceOnOff = s;

        try {
            recStore.setRecord(102, absentVoiceOnOff.getBytes(),
                               0,
                               absentVoiceOnOff.length());
        } catch (Exception e) {

        }closeRecStore();
    }

   public void setAccessRB(String s) {

        openRecStore();
        this.accessRB = s;

        try {
            recStore.setRecord(103, accessRB.getBytes(),
                               0,
                               accessRB.length());
        } catch (Exception e) {
     ...
     public void setAccessKN(String s) {

         openRecStore();
         this.accessKN = s;

         try {
             recStore.setRecord(104, accessKN.getBytes(),
                                0,
                                accessKN.length());
         } catch (Exception e) {
     ...
     public void setRoomNR(String s) {

         openRecStore();
         this.roomNR = s;

         try {
             recStore.setRecord(105, roomNR.getBytes(),
                                0,
                                roomNR.length());
         } catch (Exception e) {
     ...
     public void setLGPrefix(String s) {

         openRecStore();
         this.lgPrefix = s;

         try {
             recStore.setRecord(106, lgPrefix.getBytes(),
                                0,
                                lgPrefix.length());
         } catch (Exception e) {
   ...
   public String getGSMNumber() throws InvalidRecordIDException,
           RecordStoreNotOpenException, RecordStoreException {

       openRecStore();

       byte l[] = recStore.getRecord(101);
       gsm_number = new String(l, 0, l.length);
   ...
   public String getAbsentVoiceOnOff() throws InvalidRecordIDException,
           RecordStoreNotOpenException, RecordStoreException {

       openRecStore();

       byte l[] = recStore.getRecord(102);
       absentVoiceOnOff = new String(l, 0, l.length);

       closeRecStore();

       return absentVoiceOnOff;
   }

   public String getAccessRB() throws InvalidRecordIDException,
           RecordStoreNotOpenException, RecordStoreException {

       openRecStore();

       byte l[] = recStore.getRecord(103);
       accessRB = new String(l, 0, l.length);
    ...
    public String getAccessKN() throws InvalidRecordIDException,
            RecordStoreNotOpenException, RecordStoreException {

        openRecStore();

        byte l[] = recStore.getRecord(104);
        accessKN = new String(l, 0, l.length);
    ...
    public String getRoomNR() throws InvalidRecordIDException,
            RecordStoreNotOpenException, RecordStoreException {

        openRecStore();

        byte l[] = recStore.getRecord(105);
        roomNR = new String(l, 0, l.length);
    ...
    public String getLGPrefix() throws InvalidRecordIDException,
            RecordStoreNotOpenException, RecordStoreException {

        openRecStore();

        byte l[] = recStore.getRecord(106);
        lgPrefix = new String(l, 0, l.length);
    ...
    public void setDataStore() throws RecordStoreNotOpenException,
        ...
        if (recStore.getNumRecords() == 0) {
            ...
            writeRecord("0");              // 101. Nummer till GSM modem till LG-Nortel(CT-Server) och Siemens.
            writeRecord("0");              // 102. Talad hänvisning LG, på '1' av '0'
            writeRecord("0");              // 103. Access Kod, LG röstbrevlådan.
            writeRecord("0");              // 104. Access Kod, LG konferanssamtal.
            writeRecord("0");              // 105. Rumsnummer 1 - 7, LG konferanssamtal ().
            writeRecord("0");              // 106. LG IPECS eller IPLDK.
